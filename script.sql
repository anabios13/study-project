...
alter sequence person_person_id_seq owner to postgres;
...
(
    user_id    integer generated by default as identity
        constraint person_pkey
            primary key,
    role_id    integer
        constraint person_role_id_fkey
            references role,
    login      varchar(150) not null
        constraint person_login_key
            unique,
...
alter sequence person_person_id_seq owned by users.user_id;
...
(
    estimated_parts_id integer generated by default as identity,
    type_of_parts      integer
